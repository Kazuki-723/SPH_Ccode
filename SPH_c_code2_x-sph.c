...
int main(){
    ...
    nyg = (int)(Ly / h) + 1;
    printf("%f, %f", nxg, nyg);
    int nx1 = (int)(0.48 / ps), ny1 = (int)(Ly / ps);
    N = nx1 * ny1 ;
    m = rho0 * ps * ps;
    ...
    system("ffmpeg -y -f image2 -framerate 60 -i temp/frame%04d.ppm -loop 0 hole.gif");
    printf("Saved -> partition_break.gif\n");
    return 0;
}